...
export default function Cuisines() {
  ...
  return (
    <div style={{ paddingTop: "6rem", backgroundColor:'#EEEEEE' }}>
      <center>
        <h3 style={{color:'#222831'}}>Journey Through Culinary Traditions!</h3>
      </center>
      <div className="cuisine-main">
        {cuisineCollection.items.map((cuisine) => (
          <Link legacyBehavior key={cuisine.slug} href={`/cuisines/${cuisine.slug}`}>
          <div className="cuisine-item">
            <img src={cuisine.image.url} className="cuisine-img" alt="Image" />
